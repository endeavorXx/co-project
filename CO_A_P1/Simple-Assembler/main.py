...
for i in range(nlines):
    ...
    if query[0] == "var":
        ...
        if (i > var_count):
            error_code = 1
            print(
                f"Error at line number {i+1} variable must be declared at the beginning")
    ...
    # Type B instruction
        ...
        try:
            if (query[2][0] == "$"):
                ...
                if (num >= 0 and num <= 127):
                    ...
                    error_code = 1
                    print(
                        f"Error at line number {i+1} value error!! Imm have range: [0,127]")
            else:
        ...
        try:
            ...
            if (num >= 0 and num <= 127):
                ...
                error_code = 1
                print(
                    "Error at line number {i+1} value error!! Imm have range: [0,127]")
